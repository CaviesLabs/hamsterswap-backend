...
export class Migration1669824720448 implements MigrationInterface {
  name = 'Migration1669824720448';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "swap_proposal" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "ownerId" uuid NOT NULL, "ownerAddress" character varying NOT NULL, "fulfillBy" character varying, "expireAt" TIMESTAMP WITH TIME ZONE NOT NULL, "status" character varying NOT NULL, "note" character varying NOT NULL DEFAULT '', "searchText" character varying NOT NULL DEFAULT '', CONSTRAINT "PK_365df198e98b71d4f2cf48b300b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
