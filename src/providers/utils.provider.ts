...
import { BCryptHashProvider } from './hash/hashing.provider';
...
export class UtilsProvider {
  ...
  /**
   * @dev Generate data checksum.
   * @param data
   */
  public generateChecksum(data: string): Promise<string> {
    return new BCryptHashProvider().hash(data);
  }
}
